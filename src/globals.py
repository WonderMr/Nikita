...
class service:
    ...
    build_version                                               =   "2026.06.22-cluster-select"                         # ручной тег версии сборки; бампать при изменениях кода
# ======================================================================================================================
