...
class dictionary():
    ...
    actions['_$Job$_.Finish']                               =   'Фоновое задание. Успешное завершение'
    ...
    actions['_$Session$_.DataZoneChange']                   =   'Сеанс. Изменение текущей области'
    ...
    # ------------------------------------------------------------------------------------------------------------------
    # Развёрнутые названия важности для хранения в БД
    # ------------------------------------------------------------------------------------------------------------------
    severity_full                                           =   {}
    severity_full['N']                                      =   'Примечание'
    severity_full['I']                                      =   'Информация'
    severity_full['W']                                      =   'Предупреждение'
    severity_full['E']                                      =   'Ошибка'
    severity_full['0']                                      =   'Примечание'
    severity_full['1']                                      =   'Информация'
    severity_full['2']                                      =   'Предупреждение'
    severity_full['3']                                      =   'Ошибка'
    # ------------------------------------------------------------------------------------------------------------------
    trans_state                                             =   {}
    trans_state['0']                                        =   'R'                                                     #
    trans_state['1']                                        =   'U'                                                     #
    ...
    trans_state['3']                                        =   'N'                                                     #
    # ------------------------------------------------------------------------------------------------------------------
    # Развёрнутые названия статусов транзакции для хранения в БД
    # По документации 1С: R=Rollback, U=Unfinished, C=Commit, N=No transaction
    # ------------------------------------------------------------------------------------------------------------------
    trans_state_full                                        =   {}
    trans_state_full['R']                                   =   'Отменена'          # Rollback
    trans_state_full['U']                                   =   'Не завершена'      # Unfinished
    trans_state_full['C']                                   =   'Зафиксирована'     # Commit
    trans_state_full['N']                                   =   'Нет транзакции'    # No transaction
    trans_state_full['0']                                   =   'Отменена'          # 0 → R → Rollback
    trans_state_full['1']                                   =   'Не завершена'      # 1 → U → Unfinished
    trans_state_full['2']                                   =   'Зафиксирована'     # 2 → C → Commit
    trans_state_full['3']                                   =   'Нет транзакции'    # 3 → N → No transaction
    # ------------------------------------------------------------------------------------------------------------------
