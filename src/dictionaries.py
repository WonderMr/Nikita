...
class dictionary():
    ...
    # ------------------------------------------------------------------------------------------------------------------
    trans_state_full                                        =   {}
    trans_state_full['R']                                   =   'Отменена'
    trans_state_full['U']                                   =   'Не завершена'
    trans_state_full['C']                                   =   'Зафиксирована'
    trans_state_full['N']                                   =   'Отсутствует'
    trans_state_full['0']                                   =   'Отменена'
    trans_state_full['1']                                   =   'Не завершена'
    trans_state_full['2']                                   =   'Зафиксирована'
    trans_state_full['3']                                   =   'Отсутствует'
    # ------------------------------------------------------------------------------------------------------------------
