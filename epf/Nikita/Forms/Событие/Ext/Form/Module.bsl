...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СобытиеДляСравнения = ?(ЗначениеЗаполнено(ПредставлениеСобытия), ПредставлениеСобытия, Событие);
	...
	Если СобытиеДляСравнения = "Доступ. Доступ" Тогда
	...
	ИначеЕсли СобытиеДляСравнения = "Доступ. Отказ в доступе" Тогда
		ДанныеСобытия = ПолучитьДанныеXML(Параметры.АдресДанных);
	...
	ИначеЕсли СобытиеДляСравнения = "Сеанс. Аутентификация"
		ИЛИ СобытиеДляСравнения = "Сеанс. Ошибка аутентификации" Тогда
	...
	ИначеЕсли СобытиеДляСравнения = "Пользователи. Удаление"
		ИЛИ СобытиеДляСравнения = "Пользователи. Добавление"
		ИЛИ СобытиеДляСравнения = "Пользователи. Изменение"
		ИЛИ СобытиеДляСравнения = "Пользователи. Ошибка добавления" Тогда
		ДанныеСобытия = ПолучитьДанныеXML(Параметры.АдресДанных);
	...
	ИначеЕсли СобытиеДляСравнения = "Данные. Инициализация предопределенных данных"   Тогда
		ДанныеСобытия = ПолучитьДанныеXML(Параметры.АдресДанных);
		Элементы.ПредставленияДанных.ТекущаяСтраница = Элементы.ДанныеПользователяИБ;
		Элементы.ДанныеПользователяИБ.Видимость = Истина;
		СвойстваПользователяИБ = Новый ТаблицаЗначений;
	...
	ИначеЕсли СобытиеДляСравнения = "Информационная база. Изменение расширения конфигурации" Тогда 
		ДанныеСобытия = ПолучитьДанныеXML(Параметры.АдресДанных);
		...
		КонецЕсли;
	ИначеЕсли СобытиеДляСравнения = "Информационная база. Изменение параметров журнала регистрации" Тогда 
		ДанныеСобытия = ПолучитьДанныеXML(Параметры.АдресДанных);
	...
	ИначеЕсли СобытиеДляСравнения = "Информационная база. Обновление предопределенных данных" Тогда
		ДанныеСобытия = ПолучитьДанныеXML(Параметры.АдресДанных);
