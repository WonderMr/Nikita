...
Процедура ЗаполнитьПараметрыОтбора()
	...
	Для Каждого ПараметрОтбора Из СписокПараметровОтбора Цикл
		...
		ИначеЕсли ВРег(ИмяПараметра) = ВРег("Сеанс") Тогда
			...
			Если ТипЗнч(Значение) = Тип("СписокЗначений") Тогда
				Для Каждого ЭлементСеанса Из Значение Цикл
					Сеансы.Добавить(ЭлементСеанса.Значение);
				КонецЦикла;
			ИначеЕсли ТипЗнч(Значение) = Тип("Массив") Тогда
				Для Каждого НомерСеанса Из Значение Цикл
					Сеансы.Добавить(НомерСеанса);
				КонецЦикла;
			...
			Для Каждого НомерСеанса Из Сеансы Цикл
				СтрСеансы = СтрСеансы + ?(СтрСеансы = "", "", "; ") + НомерСеанса.Значение;
			КонецЦикла;
	...
	Если ЕстьОтборПоСтатусу Или ЗначениеЗаполнено(Транзакция) Тогда
