...
2.  Отредактируйте `.env`. У вас есть два варианта настройки баз данных:

    **Вариант А: Автоматический детект (рекомендуется)**
    
    Укажите корневой путь к базам 1С, и приложение автоматически найдёт все базы:
    ...
    **Вариант Б: Ручное указание баз**
    ...
    Укажите каждую базу вручную:

    ```ini
    # 1C Settings - ручное указание
    ...
    **Вариант В: Комбинированный**
    ...
    ```ini
    # Автодетект + дополнительные базы вручную
    C1_SRVINFO_PATH=/home/usr1cv8/.1cv8/1C/1cv8
